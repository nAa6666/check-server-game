<?php
	...
	use App\SourceQuery\Exception\InvalidArgumentException;
	use App\SourceQuery\Exception\InvalidPacketException;
	use App\SourceQuery\Exception\SocketException;
	 ...
	 * @uses App\SourceQuery\Exception\InvalidArgumentException
